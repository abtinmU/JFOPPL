...
A simple first-order probabilistic programming language in Julia (not in a working condition, yet!). This PPL will support the following inference algorithms:
- Importance Sampling
- Metropolis Hastings
- Gibbs Sampling
